...
using Reevo.LoginUi.Blazor.Server.Host.Menus;
using Reevo.LoginUi.Web.Localization;
using Reevo.LoginUi.MultiTenancy;
using Reevo.LoginUi.Web;
using Volo.Abp;
...
public class LoginUiBlazorHostModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/Reevo.LoginUi.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<AbpLoginUiWebModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}Reevo.LoginUi.Web", Path.DirectorySeparatorChar)));
